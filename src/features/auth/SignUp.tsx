  ...
  return (
    <div className="flex mt-10 items-center justify-center">
      <form
        ...
        className="space-y-2 px-6 py-8 w-[400px] max-w-full border-2 mt-4 shadow-xl rounded-lg bg-white"
      >
        ...
        <div>
          ...
          <input
            ...
            className="p-3 rounded-md w-full border-2 border-blue-500 focus:outline-none focus:border-blue-700"
          />
          {errors.username && (
        ...
        <p className="text-center text-sm text-gray-700 mt-2">Access Quickly</p>
